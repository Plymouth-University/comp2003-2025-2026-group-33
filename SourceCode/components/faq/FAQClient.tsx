...
export default function FAQClient() {
  ...
  const handleClickCard = (key: string) => {
    if (openedCard.includes(key)) setOpenedCard([]);
    else setOpenedCard([key]);
  };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-10">
              ...
              <div className="flex justify-center items-center">
                <div className="flex justify-center md:flex-1 md:justify-end max-w-lg">
                  <img
                    src="/assets/images/faq/EG---Landing-faq_top-main(D).png"
                    width={628}
                    height={621}
                    alt="home-1"
                  />
        ...
        <Section>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-6 py-10">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="border border-b-2 w-40 border-black mb-4" />
                ...
                <ul className="space-y-2">
                  {[
                    ...
                    },
                    {
                      ...
                      content: (
                        <p>
                          Open up your voucher bag by tapping the &quot;Bag&quot;
                          button, tap on your vouchers and use the code to
                          redeem from our merchants
                        </p>
                      ),
                    },
                    {
